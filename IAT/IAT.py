...
datafile.write("correct,RT,stim_kind, stim\n")
...
concept_A=visual.TextStim(win,text="A",font="ipagothic",color="skyblue",height=2.7) #pos=(-10,10) or (10,10)
concept_B=visual.TextStim(win,text="B",font="ipagothic",color="skyblue",height=2.7)  #pos=(10,10) or (-10,10)
concept_X=visual.TextStim(win,text="X",font="ipagothic",color="lightgreen",height=2.7)  #pos=(-10, 6) or (10, 6)
concept_Y=visual.TextStim(win,text="Y", font="ipagothic",color="lightgreen",height=2.7)#pos=(10, 6) or (-10, 6)
...
press=visual.TextStim(win,text="press SPACE key",font="Alial",color="white",pos=(0,-5),height=1.0)
...
IAT=visual.TextStim(win,"単語分類課題",font="ipagothic",pos=(0,0),height=1.5)
#------------------------------------------------------------------------
                     #実験開始
#------------------------------------------------------------------------
